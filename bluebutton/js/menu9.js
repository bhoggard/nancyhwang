...
if (
  ...
  document.write("<link rel='stylesheet' type='text/css' href='/bluebutton/css/menu9_abs.css'>");
  document.write("<script type='text/javascript' src='/bluebutton/js/cbe_core.js'></script>");
  document.write("<script type='text/javascript' src='/bluebutton/js/cbe_event.js'></script>");
  downgrade = false;
}
...
function windowOnload() {
  ...
  cbeMenu = new cbeDropdownMenu(
    ...
    140, 20,                               // label width and height
    140,                                  // box width
    18,                                   // item height
    2,                                    // item left padding
    '#030047',                            // background color
    'gray',                            // text color
    '#030047',                            // hover background color
    'gray'                             // hover text color
  );
